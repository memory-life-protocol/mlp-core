 ...
 *
 * Generates deterministic pseudo-embeddings from text using a hash.
 * No API calls. No external dependencies. Zero configuration.
 *
 * Used for development and testing only.
 * Similarity scores are approximate but directionally correct
 * for text that shares vocabulary.
 *
 * Replace with AnthropicEmbeddingAdapter in production.
 */
